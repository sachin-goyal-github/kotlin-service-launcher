...
kubectl delete -f infrastructure/k8s/database-deployment.yml --namespace=launcher
kubectl delete -f infrastructure/k8s/service-deployment.yml --namespace=launcher
kubectl create -f infrastructure/k8s/database-deployment.yml --namespace=launcher
